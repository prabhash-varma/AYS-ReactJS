    ...
    <div>
      ...
      >
        <div style={{ marginRight: "70px", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "flex-start" }}>
          ...
          <div>
            <p style={{ textAlign: "left", marginTop: "1px", width: "400px", fontSize: "18px", marginTop: "40px" }} aria-hidden="true">Our salon services are high-end services of your needs at your doorsteps. Offering a wide range of skin and hair care services with experience and excellent staffs. Using high-class international products which suit for all types of skins. Our motto is to be providing 100% satisfied services at all times. We always looking a customers satisfaction, hygienic workstyle, trust and workmanships. </p>
          </div>
        </div>
      ...
      <div className="salon-faqs">
        ...
        <div className="salon-collapsible">
          ...
          >
            ...
            <p>
            Week days: 10AM-8PM Weekends: 10AM-5PM
            </p>
          </Collapsible>
        </div>
        ...
        <div className="salon-collapsible">
          ...
          >
            ...
            <p>
            We love children and we happily provide services to children.
        ...
        <div className="salon-collapsible">
          ...
          trigger = <h3 style={{ display: "flex", justifyContent: "space-between" }}>
              <span>
              Are you blowdrying hair?
              </span>
              <span>+</span>
            </h3>
          >
            <p>
            Yes we will be blowdrying hair in the salon.
            </p>
          </Collapsible>
        </div>
